...
export const StandardsListPage = () => {
  ...
  const [loading, setLoading] = useState({ list: false, save: false, import: false, status: false });
      ...
      >
        <Form form={importForm} layout="vertical" requiredMark={false}>
          <Form.Item
            ...
            tooltip="Use the parse_result id generated by the PPOCR/document parsing flow."
          >
